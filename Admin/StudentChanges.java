	...
	public StudentChanges() {
			...
			if(rno.equals("") ||rno.length()==7)
			{
				...
				String gender="";
				  if(rdbtnMale.isSelected())
				  {
					  ...
					  gender="Female";
			boolean b=	u.addStudent(nametext.getText(),rollnotext.getText(),dobtext.getDate().toString(),fnametext.getText(),mnametext.getText(),parentcontacttext.getText(),urcontacttext.getText(),gender,branchtext.getText(),coursetext.getText(),semtext.getText(),addresstext.getText());
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				u.updateStudent(nametext.getText(),rollnotext.getText(),dob,fnametext.getText(),mnametext.getText(),parentcontacttext.getText(),urcontacttext.getText(),gender,branchtext.getText(),coursetext.getText(),semtext.getText(),addresstext.getText(),gmailtext.getText());
